...
from src.bitemate.agents.consolidated_meal_generator import MealPlannerPipeline
...
class BiteMateOrchestrator:
    ...
    def __init__(
        ...
        try:
            ...
            self.model_name = model_name or orchestrator_agent_params.get("model_name", "gemini-1.5-flash")
